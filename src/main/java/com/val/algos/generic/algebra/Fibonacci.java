...
public class Fibonacci {
    ...
    public static int binary(int n) {
        ...
        BinaryUtils.BinaryStepAction<SquareMatrix> matrixBinaryStepAction =
                new BinaryUtils.BinaryStepAction<SquareMatrix>() {
                    @Override
        ...
        matrix = BinaryUtils.binary(matrix, n - 2, matrixBinaryStepAction);
